...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=latin1 COMMENT='tracks tickets in one purchase and total amount';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchase` VALUES (1,'2021-01-13','18:17:16',500,'YES:1 Tickets',4),(2,'2021-01-13','10:11:12',4000,'YES:4 Tickets',1),(3,'2021-01-14','13:14:15',2000,'YES:2 Tickets',5),(4,'2021-01-14','01:02:03',1000,'YES:2 Tickets',2),(5,'2021-01-15','21:07:38',3000,'YES:3 Tickets',1),(6,'2021-01-15','21:11:33',3000,'YES:3 Tickets',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COMMENT='A ticket is for one seat in one showing';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ticket` VALUES (1,4,1,2,1088,500),(2,1,2,10,1185,1000),(3,1,2,10,1186,1000),(4,1,2,10,1187,1000),(5,1,2,10,1188,1000),(6,5,3,24,1918,1000),(7,5,3,24,1919,1000),(8,2,4,17,1337,500),(9,2,4,17,1338,500);
...
-- Dump completed on 2021-05-03  0:07:43
